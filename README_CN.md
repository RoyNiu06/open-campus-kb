...
- Cloudflare Worker 风格的 API 和前端 demo。
...
npm run preview        # 本地打开 demo，地址为 127.0.0.1:8788
...
- 前端：Cloudflare Pages、Vercel 或其他静态前端平台。
