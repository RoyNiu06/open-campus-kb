...
- `campus.config.json` - public project identity, locales, tags, trust tiers, route modes, and usage defaults.
...
2. Replace all tags with your own campus, company, or organization taxonomy.
...
- Optional structured domain engines for precise questions, such as course plans, company policies, project runbooks, or product catalogs.
